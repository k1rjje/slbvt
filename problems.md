...
(4)\
`RH:  CLF(машина)____________`\
`LH:          ДЕРЕВО.ПАДАЕТ  `\
'Дерево упало на машину.'

Отметим, что границы клауз проходит перед жестами БАБУШКА и ДОЧЬ, что, однако, не влияет на жест в другой руке. Достаточно регулярно вспомогательная рука (для правшей — левая) используется и в жесте-удержании. См. _сконструированный_ пример (4):

(5)*
`RH:  мужчина  INDEXₐ  красивый`\
`LH:           INDEXₐ__________`\
